...
namespace seguridad.Controllers
{
    public class ApplicationRolesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Area,Id,Name,NormalizedName,ConcurrencyStamp")] ApplicationRole applicationRole)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("Area,Id,Name,NormalizedName,ConcurrencyStamp")] ApplicationRole applicationRole)
        {
